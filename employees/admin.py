...
class EmployeeAdmin(admin.ModelAdmin):
    ...
    fieldsets = [
        ...
        ('Permisos granulares', {'fields': ['can_message_leads', 'can_view_stats', 'can_edit_tags'], 'description': 'Capacidades habilitadas por el superuser sin convertir al usuario en ejecutivo.'}),
