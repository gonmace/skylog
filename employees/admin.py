...
class EmployeeAdmin(admin.ModelAdmin):
    list_display = ['full_name', 'nextcloud_username', 'department', 'is_active', 'is_executive', 'agent_version_badge', 'created_at']
    list_filter = ['department', 'is_active', 'is_executive']
    ...
    fieldsets = [
        ('Información', {'fields': ['user', 'nextcloud_username', 'full_name', 'department', 'is_active', 'is_executive', 'created_at']}),
