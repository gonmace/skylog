...
class EmployeeAdmin(admin.ModelAdmin):
    list_display = ['full_name', 'nextcloud_username', 'department', 'is_active', 'is_executive', 'is_mobile', 'solo_movil', 'agent_version_badge', 'created_at']
    list_filter = ['department', 'is_active', 'is_executive', 'is_mobile', 'solo_movil']
    ...
    fieldsets = [
        ('Información', {'fields': ['user', 'nextcloud_username', 'full_name', 'department', 'is_active', 'is_executive', 'is_mobile', 'solo_movil', 'created_at']}),
